...
use ECSPrefix20210918\Symfony\Component\HttpFoundation\RequestMatcherInterface;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\RequestStack;
use ECSPrefix20210918\Symfony\Component\HttpKernel\Event\ExceptionEvent;
use ECSPrefix20210918\Symfony\Component\HttpKernel\Event\ResponseEvent;
use ECSPrefix20210918\Symfony\Component\HttpKernel\Event\TerminateEvent;
 ...
 * @final
 */
class ProfilerListener implements \ECSPrefix20210918\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $profiler;
    protected $matcher;
    ...
    {
        return [\ECSPrefix20210918\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -100], \ECSPrefix20210918\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => ['onKernelException', 0], \ECSPrefix20210918\Symfony\Component\HttpKernel\KernelEvents::TERMINATE => ['onKernelTerminate', -1024]];
    }
}
