...
use ECSPrefix20210918\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\Cookie;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\Request;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\RequestStack;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\Response;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\Session\SessionBagInterface;
use ECSPrefix20210918\Symfony\Component\HttpFoundation\Session\SessionInterface;
use ECSPrefix20210918\Symfony\Component\HttpKernel\Event\ControllerEvent;
use ECSPrefix20210918\Symfony\Component\HttpKernel\Event\ResponseEvent;
 ...
 * @final
 */
class RequestDataCollector extends \ECSPrefix20210918\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \ECSPrefix20210918\Symfony\Component\EventDispatcher\EventSubscriberInterface, \ECSPrefix20210918\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $controllers;
    private $sessionUsages = [];
    private $requestStack;
    public function __construct(\ECSPrefix20210918\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    public function collect($request, $response, $exception = null)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \ECSPrefix20210918\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \ECSPrefix20210918\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    /**
     * @param bool $raw
     */
    ...
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    /**
     * @param bool $raw
     */
    ...
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \ECSPrefix20210918\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
    ...
    {
        return [\ECSPrefix20210918\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \ECSPrefix20210918\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function collectSessionUsage() : void
    {
        ...
        for ($i = $traceEndIndex; $i > 0; --$i) {
            if (null !== ($class = $trace[$i]['class'] ?? null) && (\is_subclass_of($class, \ECSPrefix20210918\Symfony\Component\HttpFoundation\Session\SessionInterface::class) || \is_subclass_of($class, \ECSPrefix20210918\Symfony\Component\HttpFoundation\Session\SessionBagInterface::class))) {
                $traceEndIndex = $i;
                break;
            }
        }
