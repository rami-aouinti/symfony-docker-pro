 ...
 */
namespace ECSPrefix20210918\Symfony\Component\Console\Descriptor;

use ECSPrefix20210918\Symfony\Component\Console\Application;
use ECSPrefix20210918\Symfony\Component\Console\Command\Command;
use ECSPrefix20210918\Symfony\Component\Console\Input\InputArgument;
use ECSPrefix20210918\Symfony\Component\Console\Input\InputDefinition;
 ...
 * @internal
 */
class JsonDescriptor extends \ECSPrefix20210918\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
    ...
    protected function describeApplication($application, $options = [])
    {
        ...
        $description = new \ECSPrefix20210918\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\ECSPrefix20210918\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\ECSPrefix20210918\Symfony\Component\Console\Input\InputOption $option, bool $negated = \false) : array
    {
    ...
    private function getInputDefinitionData(\ECSPrefix20210918\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\ECSPrefix20210918\Symfony\Component\Console\Command\Command $command, bool $short = \false) : array
    {
