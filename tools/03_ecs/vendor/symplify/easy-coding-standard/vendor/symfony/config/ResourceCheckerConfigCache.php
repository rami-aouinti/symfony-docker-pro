 ...
 */
namespace ECSPrefix20210918\Symfony\Component\Config;

use ECSPrefix20210918\Symfony\Component\Config\Resource\ResourceInterface;
 ...
 */
class ResourceCheckerConfigCache implements \ECSPrefix20210918\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \ECSPrefix20210918\Symfony\Component\Filesystem\Filesystem();
