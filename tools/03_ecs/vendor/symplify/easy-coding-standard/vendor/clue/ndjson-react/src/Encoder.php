 ...
 */
class Encoder extends \ECSPrefix20210918\Evenement\EventEmitter implements \ECSPrefix20210918\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\ECSPrefix20210918\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
