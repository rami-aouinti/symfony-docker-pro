 ...
 */
namespace ECSPrefix20210918\Evenement\Tests;

use ECSPrefix20210918\Evenement\EventEmitter;
use InvalidArgumentException;
use ECSPrefix20210918\PHPUnit\Framework\TestCase;
class EventEmitterTest extends \ECSPrefix20210918\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \ECSPrefix20210918\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \ECSPrefix20210918\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['ECSPrefix20210918\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \ECSPrefix20210918\Evenement\Tests\Listener::getStaticData());
    }
