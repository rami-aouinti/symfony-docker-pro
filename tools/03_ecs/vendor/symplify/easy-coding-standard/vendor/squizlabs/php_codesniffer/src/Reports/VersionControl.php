    ...
    public function generateFileReport($report, $phpcsFile, $showSources = \false, $width = 80)
    {
        ...
        foreach ($report['messages'] as $line => $lineErrors) {
            ...
            if (isset($authorCache[$author]) === \false) {
                ...
                $praiseCache[$author] = ['good' => 0, 'bad' => 0];
            }
                ...
                foreach ($colErrors as $error) {
                    ...
                    if ($showSources === \true) {
                        ...
                        if (isset($sourceCache[$author][$source]) === \false) {
                            $sourceCache[$author][$source] = ['count' => 1, 'fixable' => $error['fixable']];
                        } else {
            ...
            switch ($parts[0]) {
                ...
                case 'PRAISE':
                    if (isset($praiseCache[$parts[1]]) === \false) {
                        $praiseCache[$parts[1]] = ['good' => $parts[2], 'bad' => $parts[3]];
                    } else {
                ...
                case 'SOURCE':
                    ...
                    if (isset($sourceCache[$parts[1]][$parts[2]]) === \false) {
                        $sourceCache[$parts[1]][$parts[2]] = ['count' => $parts[3], 'fixable' => (bool) $parts[4]];
                    } else {
