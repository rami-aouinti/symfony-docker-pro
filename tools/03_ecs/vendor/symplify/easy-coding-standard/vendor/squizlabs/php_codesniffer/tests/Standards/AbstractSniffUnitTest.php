...
abstract class AbstractSniffUnitTest extends \ECSPrefix20210918\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function generateFailureMessages(\PHP_CodeSniffer\Files\LocalFile $file)
    {
        ...
        */
        ...
        foreach ($foundErrors as $line => $lineErrors) {
            foreach ($lineErrors as $column => $errors) {
                ...
                foreach ($errors as $foundError) {
                    ...
                    if ($foundError['fixable'] === \true && \in_array($source, $GLOBALS['PHP_CODESNIFFER_FIXABLE_CODES'], \true) === \false) {
            ...
            //end foreach
            if (isset($expectedErrors[$line]) === \true) {
        ...
        foreach ($foundWarnings as $line => $lineWarnings) {
            ...
            //end foreach
            if (isset($expectedWarnings[$line]) === \true) {
