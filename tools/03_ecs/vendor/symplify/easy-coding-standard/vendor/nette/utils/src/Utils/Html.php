...
namespace ECSPrefix20210918\Nette\Utils;

use ECSPrefix20210918\Nette;
use ECSPrefix20210918\Nette\HtmlStringable;
 ...
 */
class Html implements \ArrayAccess, \Countable, \IteratorAggregate, \ECSPrefix20210918\Nette\HtmlStringable
{
    ...
    public static function el($name = null, $attrs = null)
    {
        ...
        if (isset($parts[1])) {
            foreach (\ECSPrefix20210918\Nette\Utils\Strings::matchAll($parts[1] . ' ', '#([a-z0-9:-]+)(?:=(["\'])?(.*?)(?(2)\\2|\\s))?#i') as $m) {
    ...
    {
        if (!$text instanceof \ECSPrefix20210918\Nette\HtmlStringable) {
